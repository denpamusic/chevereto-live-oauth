	...
	<div class="form-content">
		...
		<form id="dashboard-settings" method="post" data-type="<?php echo get_dashboard(); ?>" data-action="validate" enctype="multipart/form-data">
			...
			<div class="input-label">
				...
				<div class="c5 phablet-c1"><select type="text" name="enable_likes" id="enable_likes" class="text-input"<?php if(CHV\getSetting('website_mode') == 'personal') echo ' disabled'; ?>>
					<?php
			...
			<div class="input-label">
				...
				<div class="c5 phablet-c1"><select type="text" name="enable_followers" id="enable_followers" class="text-input"<?php if(CHV\getSetting('website_mode') == 'personal') echo ' disabled'; ?>>
					<?php
			...
			<div class="input-label">
				...
				<div class="c5 phablet-c1"><select type="text" name="require_user_email_social_signup" id="require_user_email_social_signup" class="text-input"<?php if(CHV\getSetting('website_mode') == 'personal') echo ' disabled'; ?>>
					<?php
			...
			<div class="input-label">
				...
				<div class="c4"><input type="text" name="theme_logo_height" id="theme_logo_height" class="text-input" value="<?php echo CHV\Settings::get('theme_logo_height'); ?>" placeholder="<?php _se('No value'); ?>"></div>
			...
			<div class="input-label">
				<label for="live">Windows Live</label>
				<div class="c5 phablet-c1"><select type="text" name="live" id="live" class="text-input" data-combo="live-combo">
					<?php
						echo CHV\Render\get_select_options_html([1 => _s('Enabled'), 0 => _s('Disabled')], get_safe_post() ? get_safe_post()['live'] : CHV\Settings::get('live'));
					?>
				</select></div>
				<div class="input-below"><?php _se('You need a <a href="https://apps.dev.microsoft.com/?mkt=ru-ru#/appList/create/sapi" target="_blank">Windows Live app</a> for this.'); ?></div>
			</div>
			<div id="live-combo">
				<div data-combo-value="1" class="switch-combo c9 phablet-c1<?php if(!(get_safe_post() ? get_safe_post()['live'] : CHV\Settings::get('live'))) echo ' soft-hidden'; ?>">
					<div class="input-label">
						<label for="live_client_id"><?php _se('Windows Live client id'); ?></label>
						<input type="text" name="live_client_id" id="live_client_id" class="text-input" value="<?php echo get_safe_post() ? get_safe_post()['live_client_id'] : CHV\Settings::get('live_client_id', true); ?>">
						<div class="input-warning red-warning"><?php echo get_input_errors()['vk_client_id']; ?></div>
					</div>
					<div class="input-label">
						<label for="live_client_secret"><?php _se('Windows Live client secret'); ?></label>
						<input type="text" name="live_client_secret" id="live_client_secret" class="text-input" value="<?php echo get_safe_post() ? get_safe_post()['live_client_secret'] : CHV\Settings::get('live_client_secret', true); ?>">
						<div class="input-warning red-warning"><?php echo get_input_errors()['live_client_secret']; ?></div>
					</div>
				</div>
			</div>
			<?php } ?>
